...
// 
// - processedEmailDirectory: S3 folder name where processed email files will be moved.
//   this is handy, if there are emails that are emails failed to process
//
...
var defaultConfig = {
  ...
  processedEmailDirectory: "processed",
  allowPlusSign: true,
  forwardMapping: {
    "info@example.com": [
...
/**
 * Prepare the message data, making updates to recipients and other headers
...
/**
 * Removes the message data from S3.
 *
 * @param {object} data - Data bundle with context, email, etc.
 *
 * @return {object} - Promise resolved with data.
...
exports.handler = function (event, context, callback, overrides) {
  ...
  Promise.series(steps, data)
    ...
    .catch(function (err) {
      ...
      data.log({
        level: "info",
        message: "Exiting step chain: " + err
      });
    });
};
